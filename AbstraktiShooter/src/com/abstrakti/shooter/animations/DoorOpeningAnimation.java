...
public class DoorOpeningAnimation extends SpriteAnimation {
	private Door owner;

	public DoorOpeningAnimation(Door owner) {
		super(4, 0.1f);
		this.owner = owner;
		AssetManager assets = AssetManager.getInstance();
		Sprite door = assets.getSprite("slideDoor2");
		...
		door = assets.getSprite("slideDoor5");
